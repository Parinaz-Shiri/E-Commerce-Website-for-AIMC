...
<?php require('templates/header.php') ?>
	<div class="d-flex mt-4 mx-4">
        <h3>Welcome to Online AIMC (Agricultural Industrial Machinery Company),
        	<b><?php // check user login and output username
			if ($user_logged) {
				$user_id = ($_SESSION['Subscription_Code']);
				$select_sql = "SELECT name FROM `client` WHERE Subscription_Code='$user_id'";
